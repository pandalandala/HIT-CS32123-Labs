...
public class GraphStaticTest {
    ...
    public void testEmptyVerticesEmpty() {
        assertEquals("expected empty() graph to have no vertices", Collections.emptySet(), P1.graph.Graph.empty().vertices());
    }

    // TODO test other vertex label types in Problem 3.2
    @Test
    public void testOtherType() {
        P1.graph.Graph<Integer> emptyInstance = P1.graph.Graph.empty();
